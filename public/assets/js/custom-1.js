...
/* harmony export */   "indexchart": () => (/* binding */ indexchart),
/* harmony export */   "vectormap": () => (/* binding */ vectormap)
/* harmony export */ });
var ApexCharts = __webpack_require__(/*! ./apexcharts */ "./resources/assets/js/apexcharts.js");
/* Apexcharts (#bar) */


function indexbar(myVarVal) {
  var optionsBar = {
    chart: {
      height: 249,
      responsive: 'true',
...
function vectormap(myVarVal, hexToRgba) {
...
/***/ "./resources/assets/js/themeColor.js":
/*!*******************************************!*\
  !*** ./resources/assets/js/themeColor.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _index1__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index1 */ "./resources/assets/js/index1.js");
...
var myonoffswitchTransparent = document.querySelector('#myonoffswitchTransparent');
myonoffswitchTransparent === null || myonoffswitchTransparent === void 0 ? void 0 : myonoffswitchTransparent.addEventListener('input', transparentPrimaryColor);
...
(function () {
  'use strict'; // Light theme color picker

  var LightThemeSwitchers = document.querySelectorAll('.light-theme .switch_section span');
  ...
  var DarkThemeSwitchers = document.querySelectorAll('.dark-theme .switch_section span');
  ...
  var transparentThemeSwitchers = document.querySelectorAll('.transparent-theme .switch_section span');
  ...
  var transparentBgThemeSwitchers = document.querySelectorAll('.transparent-theme .switch_section span');
  ...
  $('#myonoffswitch1').on('click', function () {
    ...
    (_document$querySelect = document.querySelector('body')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.classList.remove('dark-theme');
    (_document$querySelect2 = document.querySelector('body')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.classList.remove('transparent-theme');
  ...
  $('#myonoffswitch2').on('click', function () {
    ...
    (_document$querySelect7 = document.querySelector('body')) === null || _document$querySelect7 === void 0 ? void 0 : _document$querySelect7.classList.remove('light-theme');
    (_document$querySelect8 = document.querySelector('body')) === null || _document$querySelect8 === void 0 ? void 0 : _document$querySelect8.classList.remove('transparent-theme');
  ...
  $('#myonoffswitchTransparent').on('click', function () {
    ...
    (_document$querySelect13 = document.querySelector('body')) === null || _document$querySelect13 === void 0 ? void 0 : _document$querySelect13.classList.remove('dark-theme');
    (_document$querySelect14 = document.querySelector('body')) === null || _document$querySelect14 === void 0 ? void 0 : _document$querySelect14.classList.remove('light-theme');
...
function localStorageBackup() {
  'use strict'; // if there is a value stored, update color picker and background color
  ...
  if (localStorage.valexprimaryColor) {
    ...
    document.querySelector('html').style.setProperty('--primary-transparentcolor', localStorage.valexprimaryTransparent); // document.querySelector('body').setAttribute('class', 'app sidebar-mini light-theme');
  ...
  if (localStorage.valexdarkPrimary) {
    ...
    document.querySelector('html').style.setProperty('--darkprimary-transparentcolor', localStorage.valexdarkprimaryTransparent); // document.querySelector('body').setAttribute('class', 'app sidebar-mini dark-theme');
  ...
  if (localStorage.valextransparentPrimary) {
    ...
    document.querySelector('html').style.setProperty('--transparentprimary-transparentcolor', localStorage.valextransparentprimaryTransparent); // document.querySelector('body').setAttribute('class', 'app sidebar-mini transparent-theme');
  ...
  if (localStorage.valextransparentBgImgPrimary) {
    ...
    (_document$querySelect19 = document.querySelector('body')) === null || _document$querySelect19 === void 0 ? void 0 : _document$querySelect19.classList.add('transparent-theme');
  ...
  if (localStorage.valexBgImage) {
    ...
    (_document$querySelect22 = document.querySelector('body')) === null || _document$querySelect22 === void 0 ? void 0 : _document$querySelect22.classList.add('transparent-theme');
    var bgImg = localStorage.valexBgImage.split(' ')[0];
    ...
    (_document$querySelect25 = document.querySelector('body')) === null || _document$querySelect25 === void 0 ? void 0 : _document$querySelect25.classList.remove('light-theme');
    $('#myonoffswitchTransparent').prop('checked', true);
  }
...
function changePrimaryColor() {
  ...
  localStorage.setItem('valexprimaryColor', userColor); // to store value as opacity 0.95 we use 95

  localStorage.setItem('valexprimaryHoverColor', userColor + 95);
  localStorage.setItem('valexprimaryBorderColor', userColor);
  localStorage.setItem('valexprimaryTransparent', userColor + 20); // removing dark theme properties
...
function transparentPrimaryColor() {
  ...
  localStorage.setItem('valextransparentprimaryTransparent', userColor + 20); // removing light theme data 
...
function transparentBgImgPrimaryColor() {
  ...
  document.querySelector('body').classList.add('transparent-theme');
  (_document$querySelect35 = document.querySelector('body')) === null || _document$querySelect35 === void 0 ? void 0 : _document$querySelect35.classList.remove('light-theme');
  (_document$querySelect36 = document.querySelector('body')) === null || _document$querySelect36 === void 0 ? void 0 : _document$querySelect36.classList.remove('dark-theme');
  $('#myonoffswitchTransparent').prop('checked', true);
  checkOptions();
  names();
}
...
function transparentBgColor() {
  ...
  localStorage.removeItem('valextransparentBgImgPrimary');
  localStorage.removeItem('valextransparentBgImgprimaryTransparent'); // removing light theme data 
...
function bgImage(e) {
  ...
  localStorage.setItem('valexBgImage', imgID); // removing light theme data 
  ...
  localStorage.removeItem('valextransparentprimaryTransparent');
  document.querySelector('body').classList.add('transparent-theme');
  (_document$querySelect41 = document.querySelector('body')) === null || _document$querySelect41 === void 0 ? void 0 : _document$querySelect41.classList.remove('light-theme');
  (_document$querySelect42 = document.querySelector('body')) === null || _document$querySelect42 === void 0 ? void 0 : _document$querySelect42.classList.remove('dark-theme');
  $('#myonoffswitchTransparent').prop('checked', true);
  checkOptions();
...
var myVarVal, myVarVal2, primaryColorVal, primaryHoverColorVal;
function names() {
  'use strict';

  primaryColorVal = getComputedStyle(document.documentElement).getPropertyValue('--primary-bg-color').trim();
  primaryHoverColorVal = getComputedStyle(document.documentElement).getPropertyValue('--primary-bg-hover').trim(); //get variable
  ...
  if (document.querySelector('#bar') !== null) {
    (0,_index1__WEBPACK_IMPORTED_MODULE_0__.indexbar)(myVarVal);
  }

  if (document.querySelector('#vmap12') !== null) {
    (0,_index1__WEBPACK_IMPORTED_MODULE_0__.vectormap)(myVarVal, hexToRgba);
  }

  if (document.querySelector('#chart') !== null) {
    (0,_index1__WEBPACK_IMPORTED_MODULE_0__.indexchart)(myVarVal);
  }
  ...
  var colorData3 = hexToRgba(myVarVal || primaryColorVal, 0.5);
...
names(); // RESET SWITCHER TO DEFAULT
...
function resetData() {
  var _$, _$2, _$3, _$4, _$5, _$6, _$7, _$8, _$9, _$10, _$11, _$12, _$13, _$14, _$15, _$16, _$17, _$18, _$19, _$20, _$21, _$22, _$23, _$24, _$25, _$26, _$27, _$28, _document$getElementB, _document$getElementB2;
  ...
  (_$5 = $('body')) === null || _$5 === void 0 ? void 0 : _$5.removeClass('transparent-theme');
  (_$6 = $('body')) === null || _$6 === void 0 ? void 0 : _$6.removeClass('dark-theme');
  (_$7 = $('body')) === null || _$7 === void 0 ? void 0 : _$7.removeClass('dark-menu');
  (_$8 = $('body')) === null || _$8 === void 0 ? void 0 : _$8.removeClass('light-menu');
  ...
  (_$13 = $('body')) === null || _$13 === void 0 ? void 0 : _$13.removeClass('light-header');
  (_$14 = $('body')) === null || _$14 === void 0 ? void 0 : _$14.removeClass('color-header');
  (_$15 = $('body')) === null || _$15 === void 0 ? void 0 : _$15.removeClass('layout-boxed');
  (_$16 = $('body')) === null || _$16 === void 0 ? void 0 : _$16.removeClass('icontext-menu');
  (_$17 = $('body')) === null || _$17 === void 0 ? void 0 : _$17.removeClass('sideicon-menu');
  (_$18 = $('body')) === null || _$18 === void 0 ? void 0 : _$18.removeClass('closed-menu');
  (_$19 = $('body')) === null || _$19 === void 0 ? void 0 : _$19.removeClass('hover-submenu');
  (_$20 = $('body')) === null || _$20 === void 0 ? void 0 : _$20.removeClass('hover-submenu1');
  (_$21 = $('body')) === null || _$21 === void 0 ? void 0 : _$21.removeClass('scrollable-layout');
  (_$22 = $('body')) === null || _$22 === void 0 ? void 0 : _$22.removeClass('sidenav-toggled');
  (_$23 = $('body')) === null || _$23 === void 0 ? void 0 : _$23.removeClass('leftbgimage1');
  (_$24 = $('body')) === null || _$24 === void 0 ? void 0 : _$24.removeClass('leftbgimage2');
  (_$25 = $('body')) === null || _$25 === void 0 ? void 0 : _$25.removeClass('leftbgimage3');
  (_$26 = $('body')) === null || _$26 === void 0 ? void 0 : _$26.removeClass('leftbgimage4');
  (_$27 = $('body')) === null || _$27 === void 0 ? void 0 : _$27.removeClass('leftbgimage5');
  (_$28 = $('body')) === null || _$28 === void 0 ? void 0 : _$28.removeClass('centerlogo-horizontal');
  ...
  (_document$getElementB = document.getElementById("style")) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.setAttribute("href", "../../assets/plugins/bootstrap/css/bootstrap.min.css");
  (_document$getElementB2 = document.getElementById("style")) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.setAttribute("href", "https://laravel8.spruko.com/valex/assets/plugins/bootstrap/css/bootstrap.min.css");
...
function customresetData() {
  ...
  var _$29, _$30, _$31, _$32, _document$getElementB3, _document$getElementB4;
  ...
  $('#myonoffswitch07').prop('checked', true);
  $('#myonoffswitch03').prop('checked', true);
  (_$29 = $('body')) === null || _$29 === void 0 ? void 0 : _$29.removeClass('bg-img4');
  (_$30 = $('body')) === null || _$30 === void 0 ? void 0 : _$30.removeClass('bg-img1');
  (_$31 = $('body')) === null || _$31 === void 0 ? void 0 : _$31.removeClass('bg-img2');
  (_$32 = $('body')) === null || _$32 === void 0 ? void 0 : _$32.removeClass('bg-img3');
  $('body').addClass('ltr');
  $('body').removeClass('rtl');
  $("html[lang=en]").attr("dir", "ltr");
  $(".select2-container").attr("dir", "ltr");
  ...
  $("head link#style").attr("href", $(this));
  (_document$getElementB3 = document.getElementById("style")) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.setAttribute("href", "../../assets/plugins/bootstrap/css/bootstrap.min.css");
  (_document$getElementB4 = document.getElementById("style")) === null || _document$getElementB4 === void 0 ? void 0 : _document$getElementB4.setAttribute("href", "https://laravel8.spruko.com/valex/assets/plugins/bootstrap/css/bootstrap.min.css");
  var carousel = $('.owl-carousel');
  $.each(carousel, function (index, element) {
    // element == this
    var carouselData = $(element).data('owl.carousel');
...
"use strict";
/*!*****************************************!*\
  !*** ./resources/assets/js/custom-1.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _themeColor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./themeColor */ "./resources/assets/js/themeColor.js");
...
$(function () {
  ...
  $(document).on("click", '#myonoffswitch1', function () {
    if (this.checked) {
      ...
      localStorage.removeItem('valexdarkPrimary'); // remove light theme properties
      ...
      localStorage.removeItem('valextransparentBgImgPrimary');
      localStorage.removeItem('valextransparentBgImgprimaryTransparent');
      (_document$querySelect = document.querySelector('html')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.style.removeProperty('--primary-bg-color', localStorage.darkPrimary);
      (_document$querySelect2 = document.querySelector('html')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.style.removeProperty('--primary-bg-hover', localStorage.darkPrimary);
      (_document$querySelect3 = document.querySelector('html')) === null || _document$querySelect3 === void 0 ? void 0 : _document$querySelect3.style.removeProperty('--primary-bg-border', localStorage.darkPrimary);
      (_document$querySelect4 = document.querySelector('html')) === null || _document$querySelect4 === void 0 ? void 0 : _document$querySelect4.style.removeProperty('--dark-primary', localStorage.darkPrimary); // removing dark theme properties
      ...
      (0,_themeColor__WEBPACK_IMPORTED_MODULE_0__.checkOptions)();
      var root = document.querySelector(':root');
      root.style = "";
      (0,_themeColor__WEBPACK_IMPORTED_MODULE_0__.names)();
    } else {
  ...
  $(document).on("click", '#myonoffswitch2', function () {
    if (this.checked) {
      ...
      localStorage.removeItem('valextransparentBgImgPrimary');
      localStorage.removeItem('valextransparentBgImgprimaryTransparent');
      (_document$querySelect5 = document.querySelector('html')) === null || _document$querySelect5 === void 0 ? void 0 : _document$querySelect5.style.removeProperty('--primary-bg-color', localStorage.darkPrimary);
      (_document$querySelect6 = document.querySelector('html')) === null || _document$querySelect6 === void 0 ? void 0 : _document$querySelect6.style.removeProperty('--primary-bg-hover', localStorage.darkPrimary);
      (_document$querySelect7 = document.querySelector('html')) === null || _document$querySelect7 === void 0 ? void 0 : _document$querySelect7.style.removeProperty('--primary-bg-border', localStorage.darkPrimary);
      (_document$querySelect8 = document.querySelector('html')) === null || _document$querySelect8 === void 0 ? void 0 : _document$querySelect8.style.removeProperty('--dark-primary', localStorage.darkPrimary); // removing light theme data 
  ...
  $(document).on("click", '#myonoffswitchTransparent', function () {
    if (this.checked) {
      var _document$querySelect9, _document$querySelect10, _document$querySelect11, _document$querySelect12, _document$querySelect13, _document$querySelect14, _document$querySelect15, _document$querySelect16;
      ...
      localStorage.removeItem('valexprimaryColor');
      localStorage.removeItem('valexprimaryHoverColor');
      localStorage.removeItem('valexprimaryBorderColor'); // reseting the menu and header switcher

      (_document$querySelect9 = document.querySelector('.lightMenu')) === null || _document$querySelect9 === void 0 ? void 0 : _document$querySelect9.classList.remove('d-none');
      (_document$querySelect10 = document.querySelector('.lightMenu')) === null || _document$querySelect10 === void 0 ? void 0 : _document$querySelect10.classList.add('d-flex');
      (_document$querySelect11 = document.querySelector('.lightHeader')) === null || _document$querySelect11 === void 0 ? void 0 : _document$querySelect11.classList.remove('d-none');
      (_document$querySelect12 = document.querySelector('.lightHeader')) === null || _document$querySelect12 === void 0 ? void 0 : _document$querySelect12.classList.add('d-flex');
      (_document$querySelect13 = document.querySelector('.darkMenu')) === null || _document$querySelect13 === void 0 ? void 0 : _document$querySelect13.classList.remove('d-none');
      (_document$querySelect14 = document.querySelector('.darkMenu')) === null || _document$querySelect14 === void 0 ? void 0 : _document$querySelect14.classList.add('d-flex');
      (_document$querySelect15 = document.querySelector('.darkHeader')) === null || _document$querySelect15 === void 0 ? void 0 : _document$querySelect15.classList.remove('d-none');
      (_document$querySelect16 = document.querySelector('.darkHeader')) === null || _document$querySelect16 === void 0 ? void 0 : _document$querySelect16.classList.add('d-flex'); // removing light theme data 
  ...
  $(document).on("click", '#myonoffswitch35', function () {
    if (this.checked) {
      ...
      localStorage.removeItem("valexhorizontalHover");
      localStorage.removeItem("valexvertical"); // $('#slide-left').removeClass('d-none');
      // $('#slide-right').removeClass('d-none');
  ...
  $(document).on("click", '#myonoffswitch55', function () {
    if (this.checked) {
      ...
      $("head link#style").attr("href", $(this));
      (_document$getElementB = document.getElementById("style")) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.setAttribute("href", "../../assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
      (_document$getElementB2 = document.getElementById("style")) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.setAttribute("href", "https://laravel8.spruko.com/valex/assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
      var carousel = $('.owl-carousel');
      $.each(carousel, function (index, element) {
        // element == this
        var carouselData = $(element).data('owl.carousel');
  ...
  $(document).on("click", '#myonoffswitch54', function () {
    if (this.checked) {
      ...
      $("head link#style").attr("href", $(this));
      (_document$getElementB5 = document.getElementById("style")) === null || _document$getElementB5 === void 0 ? void 0 : _document$getElementB5.setAttribute("href", "../../assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
      (_document$getElementB6 = document.getElementById("style")) === null || _document$getElementB6 === void 0 ? void 0 : _document$getElementB6.setAttribute("href", "https://laravel8.spruko.com/valex/assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
    }
  });
...
if ($("body").hasClass("rtl")) {
  ...
  localStorage.setItem("valexrtl", true);
  localStorage.removeItem("valexltr");
  $("head link#style").attr("href", $(undefined));
  (_document$getElementB7 = document.getElementById("style")) === null || _document$getElementB7 === void 0 ? void 0 : _document$getElementB7.setAttribute("href", "../../assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
  (_document$getElementB8 = document.getElementById("style")) === null || _document$getElementB8 === void 0 ? void 0 : _document$getElementB8.setAttribute("href", "https://laravel8.spruko.com/valex/assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
  var carousel = $('.owl-carousel');
  $.each(carousel, function (index, element) {
    // element == this
    var carouselData = $(element).data('owl.carousel');
...
if ($("body").hasClass("horizontal")) {
  ...
  $('body').removeClass('hover-submenu1');
  $('body').removeClass('icontext-menu');
  $('body').removeClass('sideicon-menu'); // $('#slide-left').removeClass('d-none');
  // $('#slide-right').removeClass('d-none');

  (_document$querySelect25 = document.querySelector('.horizontal .side-menu')) === null || _document$querySelect25 === void 0 ? void 0 : _document$querySelect25.classList.add('flex-nowrap');
...
if ($("body").hasClass("horizontal-hover")) {
  ...
  $('body').removeClass('hover-submenu1');
  $('body').removeClass('icontext-menu');
  $('body').removeClass('sideicon-menu'); // HorizontalHovermenu();

  (_document$querySelect26 = document.querySelector('.horizontal-hover .side-menu')) === null || _document$querySelect26 === void 0 ? void 0 : _document$querySelect26.classList.add('flex-nowrap');
