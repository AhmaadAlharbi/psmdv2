import {checkOptions, names} from './themeColor'
$(function () {
	'use strict'
	...
	$(document).on("click", '#myonoffswitch55', function () {
		if (this.checked) {
			...
			(document.getElementById("style")?.setAttribute("href", "https://laravel8.spruko.com/valex/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"));
