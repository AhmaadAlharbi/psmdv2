...
{{-- completed tasks --}}
<div class="col-xl-4 col-lg-6 col-md-6">
    <a href="{{ route('dashboard.pendingReports') }}">
        <div class="card bg-warning-gradient">
            <div class="card-body">
                <div class="counter-status d-flex md-mb-0">
                    ...
                    <div class="ms-auto">
                        <h5 class="tx-18 tx-white-8 mb-3">Reports Ready for Approval</h5>
                        <p class="text-dark font-weight-bold">
                            North Reports: {{$pendingNorthReportsCount}} / South Reports: {{$pendingSouthReportsCount}}
                        </p>
    ...
    <div class="card bg-success-gradient">
        <div class="card-body ">
            <div class="card-order">
                <a class="text-white" href="{{ route('dashboard.archive') }}">
                    <h6 class="mb-2">Reports Archive</h6>
                    <h2 class="text-end">
                        <i class="fas fa-archive icon-size float-start text-white"></i>
