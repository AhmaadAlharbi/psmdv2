		...
		<div class="main-header-left ">
			<div class="responsive-logo">
				<a href="{{url('index')}}" class="header-logo">
					{{-- <img src="{{asset('assets/img/brand/sb-fav.png')}}" class="logo-1" alt="logo">
					<img src="{{asset('assets/img/brand/sb-fav.png')}}" class="dark-logo-1" alt="logo"> --}}
				</a>
			</div>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
					<ul class="nav nav-item  navbar-nav-right ms-auto">
							...
							<div class="dropdown-menu">
								<div class="menu-header-content bg-primary text-start">
									...
									{{-- <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You
										have
										{{ count($usersNotifications) + count($reportsNotifications) }} unread
										Notifications</p> --}}
								</div>
								<div class="main-notification-list Notification-scroll">
									<!-- Users Notifications -->
						...
						<li class="nav-item full-screen fullscreen-button">
							<a wire:click="markAsRead" class="new nav-link full-screen-link"
