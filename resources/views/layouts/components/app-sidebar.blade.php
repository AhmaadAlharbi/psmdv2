		...
		<div class="main-sidemenu">
			<div class="app-sidebar__user clearfix">
				<div class="dropdown user-pro-body">
					...
					<div class="user-info bg-light py-2 border border-primary ">
			...
			<ul class="side-menu">
				...
				<li class="slide">
					<a class="side-menu__item" href="{{ route('dashboard.userIndex') }}">
						<i class="fas fa-user side-menu__icon"></i>
						<span class="side-menu__label">User Dashboard</span>
					</a>
				</li>
				<li class="side-item side-item-category">Alerts</li>
				<li class="slide">
			...
			<li class="slide">
				<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
					<i class="fas fa-user-check side-menu__icon"></i> <!-- Placeholder employee monitoring icon -->
					<span class="side-menu__label">Employee Monitoring</span>
					<i class="angle fe fe-chevron-down"></i>
				</a>
				<ul class="slide-menu">
					<li class="side-menu__label1"><a href="javascript:void(0);">Charts</a></li>
					<li><a class="slide-item" href="{{ route('dashboard.usersList') }}">Employees</a></li>
					<li><a class="slide-item" href="{{ route('dashboard.engineersList') }}">Engineers</a></li>
				</ul>
			</li>

			<li class="slide">
				<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
					<i class="fas fa-bolt side-menu__icon"></i> <!-- Placeholder electricity icon -->
			...
			<li class="slide">
				<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
					<i class="fas fa-cogs side-menu__icon"></i> <!-- Updated icon for Relay settings -->
					<span class="side-menu__label"> Relay settings</span>
					<i class="angle fe fe-chevron-down"></i>
				</a>
				<ul class="slide-menu">
					<li class="side-menu__label1"><a href="javascript:void(0);">Charts</a></li>
				...
				<ul class="slide-menu">
					...
					<li class="sub-slide">
						...
						<ul class="sub-slide-menu">
							...
							<li><a class="sub-side-menu__item" href="{{url('file-manager-list')}}">File-Manager-List</a>
							</li>
							<li><a class="sub-side-menu__item"
									href="{{url('file-manager-details')}}">File-Manager-Details</a></li>
							<li><a class="sub-side-menu__item" href="{{url('file-attachments')}}">File-Attachments</a>
							</li>
						</ul>
					</li>
				</ul>
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					<li class="sub-slide">
						<a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span
								class="sub-side-menu__label">Mail</span><i class="sub-angle fe fe-chevron-down"></i></a>
						<ul class="sub-slide-menu">
					...
					<li class="sub-slide">
						...
						<ul class="sub-slide-menu">
							...
							<li><a class="sub-side-menu__item" href="{{url('underconstruction')}}">UnderConstruction</a>
							</li>
