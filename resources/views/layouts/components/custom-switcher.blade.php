						...
						<div class="predefined_styles">
							<div class="swichermainleft text-center">
								<div class="p-3 d-grid gap-2">
									<a href="{{url('index')}}" class="btn ripple btn-primary mt-0">View Demo</a>
									<a href="https://themeforest.net/item/valex-laravel-admin-template/27077035?gclid=EAIaIQobChMIqtiexYev-AIVxH8rCh1R1Q7REAAYASAAEgLDm_D_BwE" class="btn ripple btn-info">Buy Now</a>
							...
							<div class="swichermainleft">
								...
								<div class="switch_section">
									<div class="switch-toggle d-flex">
										...
										<div class="onoffswitch2"><input type="radio" name="onoffswitchBody" id="myonoffswitch07" class="onoffswitch2-checkbox" checked="">
											<label for="myonoffswitch07" class="onoffswitch2-label"></label>
										</div>
									</div>
									<div class="switch-toggle d-flex">
										<span class="me-auto">Body Style1</span>
										<div class="onoffswitch2"><input type="radio" name="onoffswitchBody" id="myonoffswitch06" class="onoffswitch2-checkbox">
											<label for="myonoffswitch06" class="onoffswitch2-label"></label>
										</div>
									</div>
								</div>
							</div>
