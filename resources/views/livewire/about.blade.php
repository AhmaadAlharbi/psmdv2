        ...
        @endsection
            ...
            @section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Pages</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ About Us</span>
							</div>
						</div>
                    ...
                    <div class="container">
						...
						<div class="row mb-5 rounded-5">
							<p><img src="{{asset('assets/img/photos/aboutmain.jpg')}}" class="rounded-5"  alt="image"></p>
						</div>
											...
											<div class="row">
												...
												<div class="col-xl-6">
													<div class="text-center">
														<img src="{{asset('assets/img/media/team-startup.png')}}" alt="">
													</div>
												</div>
											</div>
										</div>
                                    ...
                                    <div class="card-body">
                                        <div class="counter-status md-mb-0">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <h6 class="mb-0 text-body">Completed Projects</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="counter-status md-mb-0">
                                            ...
                                            <div class="text-center mb-1">
                                                ...
                                                <h6 class="mb-0 text-body">Total Customers</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="counter-status md-mb-0">
                                            ...
                                            <div class="text-center mb-1">
                                                ...
                                                <h6 class="mb-0 text-body">Available Employeed</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
										...
										<p class="text-center mb-0"><i class="fe fe-facebook text-primary me-3"></i><i class="fe fe-instagram text-success me-3"></i><i class="fe fe-globe text-info me-3"></i></p>
									 </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
