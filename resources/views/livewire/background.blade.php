					...
					<div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
						...
						<div class="card mg-b-20">
							<div class="card-body h-100">
								...
								<div class="example">
									<div class="gray-set">
										<div class="flex-1 bg-gray-100 ht-100p p-3 text-body">.bg-gray-100</div>
										<div class="flex-1 bg-gray-200 ht-100p p-3 text-body">.bg-gray-200</div>
										<div class="flex-1 bg-gray-300 ht-100p p-3 text-body">.bg-gray-300</div>
										<div class="flex-1 bg-gray-400 ht-100p p-3 text-body">.bg-gray-400</div>
										<div class="flex-1 bg-gray-500 ht-100p p-3 text-body">.bg-gray-500</div>
										<div class="flex-1 bg-gray-600 ht-100p p-3 text-body">.bg-gray-600</div>
										<div class="flex-1 bg-gray-700 ht-100p p-3 text-body tx-white-7">.bg-gray-700</div>
										<div class="flex-1 bg-gray-800 ht-100p p-3 text-body tx-white-7">.bg-gray-800</div>
										<div class="flex-1 bg-gray-900 ht-100p p-3 text-body tx-white-7">.bg-gray-900</div>
									</div>
								</div>
