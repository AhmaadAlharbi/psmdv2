							...
							<div class="card mg-b-20">
								<div class="card-body">
								 <h3 class="card-title  mg-b-10">Link Badges</h3>
									...
									<div class="text-wrap">
										<div class="example">
											<button type="button" class="btn btn-primary position-relative mb-2 mt-2	 badge-top-pill">
												Inbox
								...
								<h3 class="card-title  mg-b-10">BADGES</h3>
									...
									<div class="text-wrap">
										<div class="example">
											...
											<span class="badge bg-secondary me-1 my-2">Secondary</span>
											<span class="badge bg-success me-1 my-2">Success</span>
											<span class="badge bg-danger me-1 my-2">Danger</span>
											<span class="badge bg-warning me-1 my-2">Warning</span>
											<span class="badge bg-info me-1 my-2">Info</span>
											<span class="badge bg-light me-1 my-2">Light</span>
											<span class="badge bg-dark me-1 my-2">Dark</span>
										</div>
									</div>
								</div>
							</div>
								...
								<h3 class="card-title  mg-b-10">Pill Badges</h3>
									...
									<div class="text-wrap">
										<div class="example">
											...
											<span class="badge badge-pill bg-secondary me-1 my-2">Secondary</span>
											<span class="badge badge-pill bg-success me-1 my-2">Success</span>
											<span class="badge badge-pill bg-danger me-1 my-2">Danger</span>
											<span class="badge badge-pill bg-warning me-1 my-2">Warning</span>
											<span class="badge badge-pill bg-info me-1 my-2">Info</span>
											<span class="badge badge-pill bg-light me-1 my-2">Light</span>
											<span class="badge badge-pill bg-dark me-1 my-2">Dark</span>
										</div>
									</div>
								</div>
							</div>
