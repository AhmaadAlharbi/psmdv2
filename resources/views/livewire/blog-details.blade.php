					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Blog</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Blog Details</span>
						</div>
					</div>
                    ...
                    <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12">
                        <div class="card overflow-hidden">
                            <div class="item7-card-img px-4 pt-4">
                                ...
                                <img src="{{asset('assets/img/photos/blog-main.jpg')}}" alt="img" class="cover-image rounded-7 w-100">
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <ul class="list-group mb-0">
                                    <li class="list-group-item d-flex border-0 pt-3 px-0">
                                        <img src="{{asset('assets/img/photos/blog1.jpg')}}" class="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img">
                                        <div class="">
                                    ...
                                    <li class="list-group-item d-flex border-0 px-0">
                                        <img src="{{asset('assets/img/photos/blog2.jpg')}}" class="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img">
                                        <div class="">
                                    ...
                                    <li class="list-group-item d-flex pb-3 border-0 px-0">
                                        <img src="{{asset('assets/img/photos/blog5.jpg')}}" class="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img">
                                        <div class="">
                                ...
                                <div class="text-center demo-gallery">
                                    ...
                                    <ul id="lightgallery" class="list-unstyled row row-sm">
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/1.jpg')}}" data-src="{{asset('assets/img/photos/1.jpg')}}" data-sub-html="<h4>Gallery Image 1</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/1.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/2.jpg')}}" data-src="{{asset('assets/img/photos/2.jpg')}}" data-sub-html="<h4>Gallery Image 2</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/2.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/3.jpg')}}" data-src="{{asset('assets/img/photos/3.jpg')}}" data-sub-html="<h4>Gallery Image 3</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/3.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/4.jpg')}}" data-src="{{asset('assets/img/photos/4.jpg')}}" data-sub-html="<h4>Gallery Image 4</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/4.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/5.jpg')}}" data-src="{{asset('assets/img/photos/5.jpg')}}" data-sub-html="<h4>Gallery Image 5</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/5.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/6.jpg')}}" data-src="{{asset('assets/img/photos/6.jpg')}}" data-sub-html="<h4>Gallery Image 6</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/6.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/7.jpg')}}" data-src="{{asset('assets/img/photos/7.jpg')}}" data-sub-html="<h4>Gallery Image 7</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/7.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/8.jpg')}}" data-src="{{asset('assets/img/photos/8.jpg')}}" data-sub-html="<h4>Gallery Image 8</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/8.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                        <li class="col-sm-6 col-lg-4" data-responsive="{{asset('assets/img/photos/9.jpg')}}" data-src="{{asset('assets/img/photos/9.jpg')}}" data-sub-html="<h4>Gallery Image 9</h4>" >
                                            <a href="">
                                                <img class="img-responsive rounded-5" src="{{asset('assets/img/photos/9.jpg')}}" alt="Thumb-1">
                                            </a>
                                        </li>
                                    </ul>
					                <!-- /Gallery -->
