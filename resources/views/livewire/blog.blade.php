					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Blog</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Blog Pagee</span>
						</div>
					</div>
									...
									<div class="item-list">
										<ul class="list-group mb-0">
											<li class="list-group-item d-flex  border-bottom-0">
												<img src="{{asset('assets/img/photos/blog6.jpg')}}" class="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img">
												<div class="my-auto">
											...
											<li class="list-group-item d-flex border-bottom-0">
												<img src="{{asset('assets/img/photos/blog4.jpg')}}" class="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img">
												<div class="my-auto">
