            ...
            @section('content')
                ...
                <div class="row row-sm">
                    <div class="col-md-4 col-lg-4">
                        ...
                        <div class="card-body ">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div><img alt="Image" class="img-fluid card-img-bottom" src="{{asset('assets/img/photos/1.jpg')}}"></div>
                    </div><!-- col-4 -->
                    <div class="col-md-4 col-lg-4 mg-md-t-0">
                        <div class="card">
                        <div class="card-body ">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div><img alt="Image" class="img-fluid card-img-bottom" src="{{asset('assets/img/photos/2.jpg')}}"></div>
                    </div><!-- col-4 -->
                    <div class="col-md-4 col-lg-4 mg-md-t-0">
                        <div class="card">
                        <div class="card-body ">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div><img alt="Image" class="img-fluid card-img-bottom" src="{{asset('assets/img/photos/11.jpg')}}"></div>
                    </div><!-- col-4 -->
                </div>
                <!-- /row closed -->
                ...
                <div class="row row-sm">
                    <div class="col-md">
                        <div class="card overflow-hidden">
                            <img alt="Image" class="img-fluid" src="{{asset('assets/img/photos/3.jpg')}}">
                            <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
                                <p class="tx-white tx-medium mb-lg-3 mb-0">The Cat Prisoner</p>
                    ...
                    <div class="col-md mg mg-md-t-0">
                        <div class="card overflow-hidden">
                            <img alt="Image" class="card-img img-fluid" src="{{asset('assets/img/photos/5.jpg')}}">
                            <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
                                <p class="tx-white tx-medium mb-lg-3 mb-0">The Ghost Town</p>
                                <p class="tx-white-7 tx-13">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consictetur...</p>
                                <p class="tx-13 mg-b-0"><a class="tx-white" href="">Read more</a></p>
                            </div><!-- card-img-overlay -->
                        </div>
                    ...
                    <div class="col-md mg-md-t-0">
                        <div class="card overflow-hidden">
                            <img alt="Image" class="card-img img-fluid" src="{{asset('assets/img/photos/6.jpg')}}">
                            <div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center">
                                <p class="tx-white tx-medium mb-lg-3 mb-0">The Green Leaves</p>
                                <p class="tx-white-7 tx-13">Some quick example text to build on the card title and make up the bulk of the card's content. Lorem ipsum dolor sit amet consictetur...</p>
                                <p class="tx-13 mg-b-0"><a class="tx-white" href="">Read more</a></p>
                            </div><!-- card-img-overlay -->
                        </div>
