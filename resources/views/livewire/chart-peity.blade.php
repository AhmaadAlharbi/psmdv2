						...
						<div class="col-lg-12">
							<div class="card mg-b-20">
								<div class="card-body">
									...
									<p class="mg-b-20">It is Very Easy to Customize and it uses in website apllication.</p>
									<div class="d-lg-flex">
										<div class="mg-r-10 mg-t-10 wd-sm-250 border pd-x-20 pd-t-20 bg-light text-dark">
									...
									<div class="d-xl-flex">
										<div class="mg-r-10 mg-t-10 wd-sm-250 border pd-x-20 pd-b-20 bg-light text-dark">
										...
										<div class="mg-r-10 mg-t-10 wd-sm-250 border pd-x-20 pd-y-10 bg-light text-dark">
