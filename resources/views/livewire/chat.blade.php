        ...
        @endsection
            ...
            @section('content')
					...
					<div class="row row-sm mb-4">
						<div class="col-xl-12">
							<div class="row">
								<div class="col-xxl-3 col-lg-12 col-xl-4">
									<div class="card">
								...
								<div class="col-lg-12 col-xxl-6 col-xl-5">
									<div class="card">
										<div class="main-content-app">
													...
													<div class="content-inner">
														...
														<div class="media flex-row-reverse">
															...
															<div class="media-body">
																...
																<div class="main-msg-wrapper p-0 rounded-5"><img alt="" class="wd-100 ht-100 rounded-5" src="{{asset('assets/img/ecommerce/01.jpg')}}"></div>
																<div>
										...
										<div class="main-content-app">
											<div class="card-body p-0 chat-main">
												<div class="float-end m-4">
													<a href="javascript:void(0);" class="option-dots text-dark" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fe fe-more-vertical"></i></a>
