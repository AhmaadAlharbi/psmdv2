        ...
        @endsection
            ...
            @section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Apps</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ Draggable Cards</span>
						</div>
					</div>
					...
					<div class="row row-sm">
						...
						<div class="col-xl-4 col-sm-12 col-md-6 col-lg-4">
							...
							<div class="card custom-card card-draggable">
								...
								<img alt="Image" class="img-fluid card-img-bottom" src="{{asset('assets/img/photos/3.jpg')}}">
							</div>
						</div>
