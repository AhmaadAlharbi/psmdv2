											...
											<div class="row row-xs">
												<div class="col-sm-6 col-md-6">
													<div class="dropdown dropend">
														<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-info  dropdown-toggle" data-bs-toggle="dropdown" id="droprightMenuButton" type="button">Dropright</button>
