        ...
        @endsection
            ...
            @section('content')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Filemanager</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ File-Attachments</span>
						</div>
					</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="text-wrap pb-3">
									<div class="file-image-1">
										<div class="product-image">
											<a href="{{url('file-manager-details')}}">
												<img src="{{asset('assets/img/files/image.png')}}" class="rounded-5" alt="">
											</a>
											<ul class="icons">
									...
									<div class="file-image-1">
										<div class="product-image">
											<a href="{{url('file-manager-details')}}"><img src="{{asset('assets/img/files/doc.png')}}" alt=""></a>
											<ul class="icons">
												<li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-pink"><i class="fe fe-download"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-primary"><i class="fe fe-eye"></i></a></li>
									...
									<div class="file-image-1">
										<div class="product-image">
											<a href="{{url('file-manager-details')}}"><img src="{{asset('assets/img/files/file2.png')}}" alt=""></a>
											<ul class="icons">
												<li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-pink"><i class="fe fe-download"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-primary"><i class="fe fe-eye"></i></a></li>
									...
									<div class="file-image-1">
										<div class="product-image">
											<a href="{{url('file-manager-details')}}"><img src="{{asset('assets/img/files/file.png')}}" alt=""></a>
											<ul class="icons">
												<li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-pink"><i class="fe fe-download"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-primary"><i class="fe fe-eye"></i></a></li>
									...
									<div class="file-image-1">
										<div class="product-image">
											<a href="{{url('file-manager-details')}}">
												<img src="{{asset('assets/img/media/climate.jpg')}}" class="rounded-5" alt="">
											</a>
											<ul class="icons">
												<li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
												<li><a href="javascript:void(0);" class="bg-pink"><i class="fe fe-download"></i></a></li>
