        ...
        @endsection
            ...
            @section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Filemanager</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ File Manager</span>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-8 col-xl-9">
							<div class="row">
								...
								<div class="col-sm-6 col-auto col-12 file-1">
