					...
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Elements</h4><span
								class="text-muted mt-1 tx-13 ms-2 mb-0">/ Listgroup</span>
						</div>
					</div>
										...
										<div class="list-group">
												...
												<div class="media">
													<div class="d-flex mg-r-10 wd-50">
														<img class="me-4 rounded-circle avatar-md"
															src="{{asset('assets/img/faces/17.jpg')}}" alt="avatar">
													</div>
											...
											<div class="list-group-item pd-y-20">
												<div class="media">
													<div class="d-flex mg-r-10 wd-50">
														<img class="me-4 rounded-circle avatar-md"
															src="{{asset('assets/img/faces/5.jpg')}}" alt="avatar">
													</div>
													<div class="media-body">
														<div class="media-body d-flex">
											...
											<div class="list-group-item pd-y-20">
												<div class="media">
													<div class="d-flex mg-r-10 wd-50">
														<img class="me-4 rounded-circle avatar-md"
															src="{{asset('assets/img/faces/12.jpg')}}" alt="avatar">
													</div>
													<div class="media-body">
														<div class="media-body d-flex">
								...
								<div class="text-wrap">
									<div class="">
										<ul class="list-group wd-md-100p users-list-group">
											...
											<li class="list-group-item d-sm-flex d-block align-items-center">
												<img alt="" class="me-3 rounded-circle avatar-md"
													src="{{asset('assets/img/faces/15.jpg')}}">
												<div>
													<h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Joel Mendez
													</h6><span class="d-block tx-13 text-muted">Premium Member</span>
												</div>
