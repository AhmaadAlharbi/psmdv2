							...
							<div class="main-content-left main-content-left-mail card-body">
								...
								<div class="main-mail-menu">
									<nav class="nav main-nav-column mg-b-20">
										...
										<a class="nav-link" href="{{url('mail-compose')}}"><i class="bx bx-alarm-snooze"></i> Snoozed <span>6</span></a>
										<a class="nav-link" href="{{url('mail-read')}}"><i class="bx bx-bookmarks"></i> Important <span>15</span></a>
										<a class="nav-link" href="{{url('mail')}}"><i class="bx bx-send"></i> Sent Mail <span>24</span></a>
										<a class="nav-link" href="{{url('mail-compose')}}"><i class="bx bx-edit"></i> Drafts <span>2</span></a>
