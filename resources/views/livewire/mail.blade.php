									...
									<div class="main-mail-menu">
										<nav class="nav main-nav-column mg-b-20">
											<a class="nav-link active" href="">
												<i class="bx bxs-inbox"></i> Inbox <span>20</span>
											</a> 
											<a class="nav-link" href="{{url('mail-compose')}}"><i class="bx bx-star"></i> Starred <span>3</span></a> 
											<a class="nav-link" href="{{url('mail-read')}}"><i class="bx bx-bookmarks"></i> Important <span>10</span></a> 
											<a class="nav-link" href="{{url('mail-compose')}}"><i class="bx bx-send"></i> Sent Mail <span>8</span></a> 
											<a class="nav-link" href="{{url('mail-settings')}}"><i class="bx bx-edit"></i> Drafts <span>15</span></a>
											<a class="nav-link" href="{{url('mail-read')}}"><i class="bx bx-message-error"></i> Spam <span>128</span></a> 
											<a class="nav-link" href="{{url('edit-table')}}"><i class="bx bx-trash"></i> Trash <span>6</span></a>
										</nav>
										<label class="main-content-label main-content-label-sm">Label</label>
										<nav class="nav main-nav-column mg-b-20">
											<a class="nav-link" href="javascript:void(0);"><i class="bx bx-folder-open"></i> Social <span>10</span></a> 
											<a class="nav-link" href="javascript:void(0);"><i class="bx bx-folder"></i> Promotions <span>22</span></a> 
											<a class="nav-link" href="javascript:void(0);"><i class="bx bx-folder-plus"></i> Updates <span>17</span></a>
